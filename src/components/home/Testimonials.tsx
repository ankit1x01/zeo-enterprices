...
const testimonials = [
    ...
    },
    {
        ...
        refund: "₹31,200",
        rating: 5,
        text: "Had mutual fund redemptions and was confused about which form to use. Zio's CA sorted it out in one call, computed LTCG correctly, and filed everything same day. Highly recommend!",
        initials: "RV",
        color: "#e59f1c",
    },
    {
    ...
    },
    {
        ...
        refund: "₹55,800",
        rating: 5,
        text: "Filed NRI return with DTAA claim on UAE salary. Zio handled Form 67, TRC, and coordination with my employer. First time I got full TDS refund without any notice from IT department.",
        initials: "SN",
        color: "#8b5cf6",
    },
    {
